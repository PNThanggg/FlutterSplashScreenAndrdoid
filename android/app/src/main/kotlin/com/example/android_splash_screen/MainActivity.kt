...
class MainActivity : FlutterActivity() {
    ...
    private fun hideSplashScreenAnimation() {
        val splashView = findViewById<ConstraintLayout>(R.id.container)
        splashView
            .animate()
            .alpha(0.0f)
    ...
    private companion object {
        const val SPLASHSCREEN_ALPHA_ANIMATION_DURATION = 500.toLong()
        const val SPLASHSCREEN_TY_ANIMATION_DURATION = 500.toLong()
        const val SPLASHSCREEN_FINAL_ANIMATION_ALPHA_ANIMATION_DURATION = 250.toLong()
